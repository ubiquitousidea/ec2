...
7. Find the public IP address of your instance on the Instances section of the EC2 dashboard. In the table of instances, IP will be listed under a column with the name `IPv4 Public IP`. This is the public address of the virtual machine you just created. Your user id on this machine will be `ubuntu`.
...
Your OS may ask you if you want to allow the remote machine to be added to a trusted hosts list. To allow this, type `yes`.
